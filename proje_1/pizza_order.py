...
# Form implementation generated from reading ui file 'pizzasepet.ui'
#
...
class Ui_siparis_window(object):
    ...
    def sepetigoruntuleeklenecekveriler(self):
        ...
        if not pizza_exist:
            print("You must select at least 1 pizza to add!") # do that with message box
            return False
    ...
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "selection the pizz and addiation made"))
