...
# Form implementation generated from reading ui file 'siparishesap.ui'
#
...
class Ui_CardPurchasewindow(object):
    ...
    def credi_card_show_window(self):
        ...
        if (self.addcredicard.check_creditcard(personal_numb)!=None):
            a,b,c,d=self.addcredicard.check_creditcard(personal_numb)
            print(self.addcredicard.check_creditcard(personal_numb))
            mounth,year=c.split("/")
            print(b,mounth,year,d)
            self.card_no_line_edit.setText(b)
            self.day_spinbox.setValue(int(mounth))
    ...
    def credi_card_message_box(self):
        dialog=QMessageBox()
        dialog.setText("checked the credi card number , date, cvv")
